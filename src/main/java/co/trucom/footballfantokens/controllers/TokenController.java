...
public class TokenController {
	...
	@PutMapping("/{code}")
	public ResponseEntity<FanTokenDto> updatePrice(@PathVariable String code, @RequestParam Double newPrice) {
		return new ResponseEntity<>(tokenService.updatePrice(code, newPrice), HttpStatus.OK);
	}
